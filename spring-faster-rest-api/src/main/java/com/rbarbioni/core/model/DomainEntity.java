package com.rbarbioni.core.model;
...
public abstract class DomainEntity implements Serializable {
	...
	public DomainVO toVO( Class<? extends DomainVO> clazz ) throws IllegalAccessException, InstantiationException {
		DomainVO vo = clazz.newInstance();
