...
import com.rbarbioni.core.data.JpaRepositoryImpBase;
...
@EnableJpaRepositories(repositoryBaseClass = JpaRepositoryImpBase.class, basePackages={"br.com.rbarbioni.app.*"})
@ComponentScan(basePackages={"br.com.rbarbioni.app.*"})
@EntityScan(basePackages = "br.com.rbarbioni.app")
